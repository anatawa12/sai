...
public class NativeJavaClass extends NativeJavaObject implements Function
{
    ...
    public Scriptable construct(Context cx, Scriptable scope, Object[] args)
    {
        ...
        if (args.length == 0) {
            throw RuntimeErrors.reportRuntimeError0("msg.adapter.zero.args");
        }
    ...
    static Scriptable constructSpecific(Context cx, Scriptable scope,
                                       Object[] args, MethodOrConstructor ctor)
    {
    ...
    static Object constructInternal(Object[] args, MethodOrConstructor ctor) {
        return MemberBox.newInstance(ctor.asConstructor(),
                MemberBox.marshallParameters(ctor, args));
    }
