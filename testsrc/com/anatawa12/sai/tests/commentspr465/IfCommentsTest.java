...
public class IfCommentsTest {
    ...
    public void blockCommentinElse() {
        ...
        Assert.assertNotNull(ifSt.getElseKeyWordInlineComment());
        Assert.assertEquals("//test else", ((Comment) ifSt.getElseKeyWordInlineComment()).getValue());
    ...
    public void commentsInElseIf() {
        ...
        Assert.assertEquals("//else 2", ((Comment) elsePartIfSt.getElseKeyWordInlineComment()).getValue());
