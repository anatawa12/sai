...
public class SwitchCommentsTest {
    ...
    public void inlineCommentForSwitch() {
        ...
        String expectedStr = "function f1() {\n" +
                "  switch (a) {\n" +
                "    case 1:\n" +
                "  }\n" +
                "}\n";
    ...
    public void inlineCommentForCase() {
        ...
        Assert.assertEquals("//testcase", ((Comment) caseNodes.get(1).getInlineComment()).getValue());
    }
    ...
    public void inlineCommentForCaseBlock() {
        ...
        Assert.assertTrue (case9.getStatements().size() == 1 && case9.getStatements().get(0).getType() == Token.BLOCK);
        ...
        Assert.assertEquals(Token.COMMENT, firstCommentChild.getNext().getNext().getNext().getNext().getType());
    }
